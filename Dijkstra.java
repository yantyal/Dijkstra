...
public class Dijkstra {
	...
	/**
	 * 始点からつながっているすべての地点のコストを求める
	 *
	 * @param start 始点のインスタンス
	 * @param grid 重みグラフのインスタンス
	 * @return 重みグラフの高さと幅が一致した二次元配列(始点からの最小コストを格納されている)
	 */
	public int[][] dijkstraAllCost(Point start, Grid grid) {
	 ...
	 * @return
	 */
	public int[][] dijkstraShortestPath(Point point, Grid grid) {
